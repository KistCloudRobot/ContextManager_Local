...
:- asserta(library_directory('/home/rise-jjm/Workspace/ROS/social_ws/src/socialrobot/src/socialrobot_knowledge/cmProlog/knowrob_library')).
:- asserta(library_directory('/home/rise-jjm/Workspace/ROS/social_ws/src/socialrobot/src/socialrobot_knowledge/cmProlog/agent')).
:- asserta(library_directory('/home/rise-jjm/Workspace/ROS/social_ws/src/socialrobot/src/socialrobot_knowledge/cmProlog/matrix')).
...
:- use_module(library('prolog/predicate_vrep_social')).
...
:- rdf_load(library(owl/vrep_model_social_20200429)).
