...
public class L1_TM extends ArbiAgent {
	...
	public static final String DC_URL = "dc://L1_TM";
	...
	public void onStart() {
		...
		dc.connect("tcp://localhost:61616", "dc://L1_TM", BrokerType.ZEROMQ);

		System.out.println("======Start L1_Task_Manager======");
